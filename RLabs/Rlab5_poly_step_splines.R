...
# span = .2 para definir a vizinhança como 20% dos dados
fit = loess(wage ~ age, span=.2, data=Wage)
# span = .5 para definir a vizinhança como 50% dos dados
...
## Para rodar um GAM usando Natural splines, podemos utilizar
## o comando nativo de lm
gam1 = lm(wage ~ ns(year,4) + ns(age,5) + education, data=Wage)

## Para rodar um GAM utilizando smoothing splines
...
# GAM usando Local Regression como building Block
...
## GAM para variáveis binárias
## Aqui, estamos criando uma variável binária de renda maior
## que 250 on the fly
